    ...
    return (
        <Link
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="relative flex h-full flex-col overflow-clip rounded-md bg-primary">
                ...
                <div className="flex h-fit min-h-48 w-full shrink-0 flex-col gap-2 bg-primary p-5">
